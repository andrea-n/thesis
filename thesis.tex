...
%  \item \verb|planColors| – barvy svislých čar značících časové limity,
  \item \verb|gameColors|, \verb|lightenedColors|, \verb|planColors| – určuje barvy úrovní ve vizualizaci, které se zadávají  jako pole barev v~hexadecimálním kódu, konkrétně jde o~barvy aktuálních úrovní, odehraných úrovní a~čar pro časové limity,
