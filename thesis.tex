...
Vzhledem ke zmíněným cílům jsou podstatné záznamy s dokončením úrovně, využitou nápovědou, zobrazeným řešením a přeskočením úrovně. Také je nutné znázornit porovnání s časovým plánem. Naproti tomu nemusí být nutné, aby vyučující viděli nesprávná řešení. Je tedy nutné vhodným způsobem zobrazovat následující údaje:
\begin{itemize}
  \item časový odhad úrovní,
  \item skutečně strávený čas v úrovni,
...
\begin{figure}[h]
  ...
  \label{fig:progress1}
\end{figure}
Na obrázku \ref{fig:progress1} je znázorněn průběh hry krátce po jejím začátku společně s časovými odhady jednotlivých úrovní. Každému týmu přísluší jeden řádek, název týmu je uveden nalevo. Sloupce pak značí jednotlivé úrovně, které se odlišují svou barvou. V pravém horním rohu se zobrazuje uplynulý čas.
\begin{enumerate}
