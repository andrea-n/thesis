...
Vytvořená vizualizace byla integrována do Angular aplikace a později byla začleněna do připravené kostry portletu \verb|kypo2-portlet-empty-angular|. Aplikace obsahuje jeden hlavní modul a její architektura je znázorněna na obrázku \ref{fig:architecture}.
\begin{figure}[H]
  \begin{center}
