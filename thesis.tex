...
Popsaný prototyp hry byl již otestován při mnoha různých příležitostech, jak národních i mezinárodních, a to lokálně i vzdáleně, a taktéž byla zapojena škála uchazečů lišících se věkem, znalostmi i zkušenostmi (dle zdroje \cite{ctfDesign} to bylo již v roce 2016 celkem 18 příležitostí a přibližně 260 účastníků).
Díky  byly získány následující poznatky:
