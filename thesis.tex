...
Za účelem načítání dat skrze REST API byla implementována služba \verb|LoadDataService|. Ta vrací načtená data v potřebném formátu, a tak s nimi může komponenta vizualizace přímo pracovat. Služba získává data s pomocí modulu HttpClient, který je součástí frameworku Angular.

\subsection{Popis API}
Aplikace využívá dva zdroje API, vrácené odpovědi jsou ve formátu JSON.
%\begin{itemize}
...
\begin{itemize}
  ...
  Další zdroj vrací podle specifikovaného ID hry pole jejích událostí. Každá událost nese několik informací, např.:
  	\begin{itemize}
  	  \item id hráče,
