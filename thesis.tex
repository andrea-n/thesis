...
co potřebujeme sledovat, vzhledem k cílům vizualizace jsou relevantní které události
\begin{itemize}
  \item časový odhad úrovní,
  \item skutečně strávený čas v úrovni,
  \item porovnání časového odhadu a skutečného času,
  \item využité nápovědy, zobrazená řešení a přeskočení úrovně
  \item čas od začátku hry
\end{itemize}
dále vizualizace by měla být
interaktivní, 
responzivní
