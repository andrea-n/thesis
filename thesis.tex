...
\subsection{Závěrečný přehled}%Závěrečný
...
NENI SEZNAM ID HER!!!! PROTO JE ID V CONFIGU
...
\begin{itemize}
  ...
  \item \verb|levelsTimePlan| – udává odhadovanou dobu řešení pro každou úroveň, zadává se v sekundách jako pole čísel např. [1200, 1500, 1900, 2100],
