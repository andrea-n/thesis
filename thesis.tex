...
Vizualizace, která je výsledkem praktické části této práce, pracuje s daty získávanými v průběhu CtF her v prostředí KYPO, popsaných v předchozí kapitole \ref{ctfGamesKYPO}.
...
Díky implementovanému vylepšení se zaznamenávají data užitečná pro analýzu těchto her
analýza dat pomáhá při odhalování nedostatků a při budoucím návrhu a zlepšování her, aby byly pro účastníky co nejvíce zajímavé
lze sledovat např. jestli délka urovni odpovida predpokladu , jestli využívají nového systému nápoved a zda jsou napovedy uzitecne.
...
na základě dat zaznamenaných ze hry a získaných z dotazníků se zatím podařilo dojít k těmto závěrům:
- Hráči využívají zdokonalený systém nápověd a možnost zobrazení řešení
- Nepodařilo se zjistit, zda nápovědy účastníkům pomáhají, protože odpovědi z dotazníků neodpovídaly záznamům ze hry. Někteří v dotazníku uvedli, že jim nápověda pomohla, přestože žádnou nevyužili, nebo naopak uvedli, že nápovědu nepotřebovali, i když ji ve skutečnosti použili.
- Mnozí hráči, kteří využili zobrazení řešení, dokázali úroveň dokončit, jejich počet je ale menší, než se předpokládalo.
- Úrovně 4 a 6 byly hodnoceny jako nejtěžší, čemuž odpovídal i průměrný čas na jejich dokončení, který byl u obou znatelně větší než předpokládaný.

ale také aby vyučujícím daly přehled o tom, jak jednotlivé týmy postupují a které by mohly potřebovat jejich pomoc
důležité otázky
