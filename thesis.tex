...
Jednotlivé řádky je možné zarovnat podle jejich počátku, aby odpovídaly tomuto pohledu z grafického návrhu. Dojde tak ale k jejich posunutí a řádky přestanou být zarovnány s časovou osou ukazující aktuální moment, čímž tato osa ztratí smysl. Proto byly implementovány dva různé pohledy.
