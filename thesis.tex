...
Aplikace dokáže načítat data z CSV souborů a také pomocí rozhraní, které poskytuje podobné záznamy v jiném formátu. CSV soubor se záznamy ze hry lze nahrát pomocí tlačítka. Pro oba zdroje existuje v aplikaci služba, která načítání dat zajištuje.
...
\subsection{Zoom}
Graf vizualizace je možné v určitých mezích přibližovat a oddalovat pomocí kolečka myši. Výřez pak lze tažením posunovat. Princip zpracování těchto událostí je popsán u příslušných direktiv \ref{directives}.\par
