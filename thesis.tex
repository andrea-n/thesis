...
Díky těmto událostem bylo získáno několik poznatků, které vedly k následným vylepšením herního modulu. Jedná se o následující poznatky:
\begin{itemize}
  \item náročnost úrovní není vyvážená a některé úrovně často vyžadují více času, než se předpokládalo,
  ...
  \item není vhodné, pokud jsou informace poskytovány mimo herní platformu,
