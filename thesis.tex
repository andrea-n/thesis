...
\begin{figure}[H]
  ...
  \end{center}
  \caption{Grafické znázornění architektury aplikace.}
...
\begin{itemize}
  \item game started – uloží čas začátku hry daného týmu,
  \item correct flag submited, případně game finished, game exited – jelikož tyto události ukončují úroveň, jejich čas je uložen k dané úrovni jako její celkový čas,
  \item hint taken, solution displayed a level skipped – přidá danou událost do pole událostí.
\end{itemize}
