...
\begin{itemize}
  ...
  \item \verb|gameDataset| – pole objektů představující týmy, které má popsanou strukturu potřebnou pro použití s \verb|d3.stack|, uchovává však některé informace navíc – např. využité nápovědy, celkově strávený čas apod.,
  	%\begin{itemize}
...
\end{figure}
Po skončení hry, nebo i v jejím průběhu je možné se přepnout do druhého pohledu \ref{fig:visualizationChartFinal}. Tento pohled poskytuje celkové srovnání jednotlivých týmů. Řádky jsou zarovnány podle začátku hry. Lze je ale také srovnat podle začátku libovolné úrovně, nebo je podle délky úrovně řadit. Je tak možné porovnávat celkovou délku hry nebo čas jednotlivých úrovní mezi všemi týmy.\par
