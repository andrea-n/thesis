...
Díky implementovanému vylepšení se zaznamenávají data, která se mohou dále zpracovávat a jsou užitečná pro analýzu těchto her
...
lze sledovat např. jestli čas potřebný pro zvládnutí úrovně odpovídá stanovenému limitu, jestli využívají nového systému nápoved a zda jsou napovedy uzitecne.
ale také aby vyučujícím daly během hry přehled o tom, jak jednotlivé týmy postupují, v jaké úrovni se nacházejí, jak jsou úspěšní a které týmy by mohly potřebovat jejich pomoc

\section{Požadavky na vizualizaci}
\section{Požadavky na technologie}
Z hlediska použitých technologií a implementace do projektu KYPO byly specifikovány následující požadavky:
\begin{itemize}
  \item vizualizace bude ve formě Liferay portletu,
  \item základ bude v podobě samostatného Angular 2 modulu,
  \item bude využita knihovna D3.js.
\end{itemize}
KYPO využívá vlastní webový portál postavený na platformě Liferay a je tedy samozřejmým požadavkem, aby byla vizualizace součástí tohoto portálu jako samostatný portlet. Aplikace vizualizace má být postavena na Angular2, protože byl vybrán jako jednotný framework pro vývoj dalších portletů do KYPO portálu a později byla připravena kostra portletu využívající tento framework jako základ pro nové projekty. Samotná vizualizace pak má být vykreslována pomocí knihovny D3.js určenou právě pro vizualizaci dat.
