...
Struktura potřebná pro vykreslení svg elementů je z těchto dat vypočítána pomocí \verb|stack| z D3.js. Je třeba specifikovat klíče, podle nich se pak data seskupí a vypočítají se body jednotlivých vrstev.
...
```
\end{markdown*}
Vypočítané hodnoty již určují body v grafu, v tomto případě \mbox{x-ové} souřadnice úrovně pro každý tým. Na základě těchto hodnot už mohou být vykresleny jednotlivé SVG obdélníky \verb|<rect>| do grafu.
