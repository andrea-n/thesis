...
Díky těmto událostem bylo získáno několik poznatků, které vedly k následným vylepšením herního modulu a úpravám prototypu hry. Jedná se o následující poznatky:
\begin{itemize}
...
\end{itemize}
Ze zkušeností vyplynulo, že náročnost jednotlivých úrovní není stejná a na některých úrovních strávilo mnoho účastníků více času, než se očekávalo. Také často měli místo problému s nalezením řešení potíže spíše s jeho realizací, jako např. nezkušenost s příkazovým řádkem nebo opomenutí restartu služby po změně konfigurace.\par
